...
python annotate.py review --video ssd_install_01.mp4 \
    --output ground_truth_ssdinstall1.json --annotator "Your Name"

# 3. validate, then re-score everything
python annotate.py validate --ground-truth ground_truth_ssdinstall1.json \
...
**Annotate to `ANNOTATION_PROTOCOL.md`.** Consistency across clips matters more
